...
CORE_DATA = {
    ...
    "default": {
        ...
        "q2": "Что чувственно при мысли о деньгах?", "ans2": ["Обида на текущую систему", "Страх, что ресурсы закончатся", "Азарт и понимание масштаба"],
...
# Этот блок заставляет бота отвечать на сообщения в чате при просмотре сайта
try:
